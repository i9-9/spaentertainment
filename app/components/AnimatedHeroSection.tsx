...
export default function AnimatedHeroSection() {
  ...
  // useScroll trackea el scroll mientras la sección está en el viewport
  // La animación se completa cuando el usuario hace scroll dentro de esta sección
  ...
  // POSICIONES FINALES (scroll = 1) - todas centradas verticalmente (un poco arriba)
  const finalY = -8; // Negativo para mover hacia arriba
  ...
  const experienciasY = useTransform(
    scrollYProgress,
    [0, 1],
    [`${experienciasInitialY}vh`, `${finalY}vh`]
  );
  ...
  return (
    <section
      ...
      style={{ height: "200vh" }} // Altura para permitir el scroll de la animación
    >
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden z-10">
        {/* Wrapper que compensa el navbar y centra el contenido en el área visible */}
